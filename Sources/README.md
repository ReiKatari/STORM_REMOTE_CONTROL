...
[![Tech](https://img.shields.io/badge/Tech-.NET+10+%2f+WebRTC+%2f+DirectX-6366F1.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_REMOTE_CONTROL)
...
**STORM REMOTE CONTROL** — компонент экосистемы **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
